...
# time python3 /home/${USER}/script/python/compute_daily-mean_mpc.py psl 7 1969 3 ## FASTEST OPTION
time python3 /home/${USER}/script/python/compute_daily-mean_dask.py psl 7 1969 3
