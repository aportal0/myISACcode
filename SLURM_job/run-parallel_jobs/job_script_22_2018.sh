...
# time python3 /home/${USER}/script/python/compute_daily-mean_mpc.py psl 22 2018 4 ## FASTEST OPTION
time python3 /home/${USER}/script/python/compute_daily-mean_dask.py psl 22 2018 4
